...
class PlantaeAPI(APIView):
	...
	def put(self,request):
		...
		plantae.canopy_height = int(plantae_reg['canopy_height'])
		...
		plantae.main_axis_diameter = float(plantae_reg['main_axis_diameter'])
		plantae.phenology = plantae_reg['phenology']
		plantae.pollen_aggregation = plantae_reg['pollen_aggregation']
		plantae.pollen_size = float(plantae_reg['pollen_size'])
		...
		plantae.seeds_diaspore = int(plantae_reg['seeds_diaspore'])
		plantae.seed_size_class = int(plantae_reg['seed_size_class'])
		plantae.sporophyte_cost = plantae_reg['sporophyte_cost']
		plantae.save()
		data = {'plantae':plantae.plantae}
